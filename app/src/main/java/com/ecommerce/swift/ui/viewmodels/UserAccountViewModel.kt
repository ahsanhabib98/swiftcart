...
import com.ecommerce.swift.Swift
import com.ecommerce.swift.data.User
import com.ecommerce.swift.utils.Constants.ADMIN_COLLECTION
import com.ecommerce.swift.utils.Constants.PROFILE_IMAGE_COLLECTION
import com.ecommerce.swift.utils.Constants.USER_COLLECTION
import com.ecommerce.swift.utils.Resource
import com.ecommerce.swift.utils.validations.LoginRegisterValidation
import com.ecommerce.swift.utils.validations.validateEmail
                ...
                try {
                    ...
                    val imageBitmap = if (Build.VERSION.SDK_INT < 28) {
                        MediaStore.Images.Media.getBitmap(
                            getApplication<Swift>().contentResolver,
                            imageUri
                        )
                    } else {
